...
( 
	...
	KDTreeNode_GPU  * kdTree,	// IN: KD Tree (Nodes)
...
)
{
	...
	__shared__ KDTreeNode_GPU currNodes[KD_THREADS_PER_BLOCK];
	__shared__ KDSearch_GPU_Alt searchStack[KD_STACK_SIZE][KD_THREADS_PER_BLOCK];
